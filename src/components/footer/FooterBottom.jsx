    ...
    <div className="mt-[100px]  pb-[100px]">
      <Container>
        ...
        <div className="flex justify-between">
          <div>
            <span className='font-["Montserrat"] text-[14px] text-[#303030] leading-5 font-normal'>
              Copyright © 2023 E-Shop. All Rights Reserved.
            </span>
          </div>

          <div className="flex gap-5 items-center">
            <h5 className='font-["Montserrat"] font-normal text-[14px] leading-5 text-[#303030] hover:text-[#ff624c] duration-300 '>
              <Link to={"#"}>Privacy Policy</Link>
            </h5>
