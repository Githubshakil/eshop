      ...
      <Container>
        <div className="mb-20">
          ...
          <div className="flex justify-between items-center mt-6 mb-12 ">
            <p className='font-["Montserrat"] text-[20px] font-normal leading-[30px] text-[#303030]'>
          ...
          <div className="flex items-center justify-center gap-12 ">
            <div className=" border border-transparent  hover:border-[rgba(48,48,48,0.25)]  hover:border- duration-300  rounded-[25px] cursor-pointer ">
              ...
              <h5 className='font-["Poppins"] text-2xl font-semibold leading-[30px] mb-8 w-[439px]'>
                Our Category Choices for Top 10 Tech Gadgets in 2023
              </h5>
              <div className="flex items-center justify-between mb-12 ">
                <button className="py-[7px] px-5 bg-[#ff624c] text-white rounded-[10px] text-center  ">
                  Gadgets
                </button>
