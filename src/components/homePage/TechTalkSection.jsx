  ...
  return (
    ...
    <Container>
        ...
        <div className='flex items-center gap-12 '>
            <div className=' border border-transparent max-w-[544px] px-[52px] py-[52px] hover:border-[rgba(48,48,48,0.25)]  hover:border- duration-300  rounded-[25px] cursor-pointer'>
