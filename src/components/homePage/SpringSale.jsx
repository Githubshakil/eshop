            ...
            <Container>
                <div className="flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex flex-col">
                        <Slider {...settings}>
                            <ProductLayout image={true} blankimg={false} percentValue="40%" percentTag={false} category="CAMERA" title="Mini Polaroid Camerafor Girls with Flash Li..." rating="3" totalRating="(60)" price="79.00" border={true} bg="transparent" stock={stock} stockAmount="70" />
                            ...
                            <ProductLayout image={true} blankimg={false} percentValue="30%" percentTag={true} category="LAPTOP" title="Ultra Slim Laptop 14 inch 8GB RAM..." rating="4" totalRating="(120)" price="999.00" border={true} bg="transparent" stock={stock} stockAmount="30" />
                            <ProductLayout image={true} blankimg={false} percentValue="20%" percentTag={false} category="HEADPHONES" title="Wireless Noise Cancelling Headphones..." rating="4" totalRating="(80)" price="199.00" border={true} bg="transparent" stock={stock} stockAmount="40" />
                        </Slider>
                    </div>
                </div>
            </Container>
