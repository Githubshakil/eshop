            ...
            <div className="w-full lg:w-1/2 flex flex-col items-start">
              ...
              <div className="w-full max-w-[400px] flex justify-between items-baseline">
                <div className="flex flex-col items-center">
                  <h6 className='font-["Poppins"] text-[28px] lg:text-[35px] font-semibold leading-[38px] lg:leading-[46px] text-[#FF624C]'>
                    {timeLeft.days <= 9 ? `0${timeLeft.days}` : timeLeft.days}
                  </h6>
                  <p className='font-["Montserrat"] text-base font-normal leading-6 text-[#303030]'>
                    Days
                  </p>
                </div>
                <span className="text-[#FF624C] text-[28px] lg:text-[36px]">
                  :
                </span>
                <div className="flex flex-col items-center">
                  <h6 className='font-["Poppins"] text-[28px] lg:text-[35px] font-semibold leading-[38px] lg:leading-[46px] text-[#FF624C]'>
