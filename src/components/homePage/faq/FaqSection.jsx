...
const FaqSection = () => {
    ...
    let accordiandata = [
        ...
        },
        {
            ...
            content:"Shipping times for Microsoft products can vary based on location and shipping method. According to Microsoft's support page, delivery times depend on the shipping option selected. For example, expedited shipping typically takes 2-3 business days, while express shipping can take 1-2 business days. However, availability and delivery times may differ for Bangladesh, so I recommend checking the official Microsoft Store or local retailers for more precise details.",
        },
        {
            title:"Do you offer international shipping?",
            content:"es, Microsoft does offer international shipping, but availability depends on the country. The Microsoft Store ships to select countries, and delivery times vary based on location and shipping method. Some products may have restrictions due to export regulations.",
        },
        {
            title:"Can I track my order?",
            content:"Absolutely! Once your order has been shipped, we'll send you a tracking number and a link to our carrier's website where you can track your package in real-time. You can also check the status of your order bylogging into your account and viewing your order history.",
        }
    ]
  return (
   <>
