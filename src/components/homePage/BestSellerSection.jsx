        ...
        <div className="flex justify-between gap-[74px] mt-[80px]">
          ...
          <div>
            <div className="flex items-center justify-between gap-[601px] mb-[48px]">
              <div>
                <SubHeading subText={"Best Seller"} />
              </div>
              <div>
          ...
          <div className="max-w-[544px] bg-[#f4f4f4] pt-20 text-center ">
            <h4 className='w-[247px] font-["Poppins] text-[36px] font-semibold leading-[46px] text-[#303030]  mx-[148px] '>
              Buy One,Get One Free!
            </h4>
            <p className='max-w-[471px] font-["Montserrat"] text-[20px] font-normal leading-[30px] text-[#303030] text-center mx-[36px] mt-5 mb-12'>
