    ...
    <Container>
      <div className="flex justify-between items-center py-8">
        ...
        <div className="flex items-center">
          ...
          <div className=' flex flex-col justify-center relative pl-[50px] before:content-[""] before:bg-[#bfbfbf] before:absolute before:w-[1px] before:h-[32px] before:right-[-40px] before:top-[50%] before:-translate-[50%]'>
          ...
          <div className="relative pl-[50px] ml-[89px] flex flex-col justify-center">
            <div className="absolute top-[5px] left-0">
              <UserIcon />
            </div>
            <p className='font-["Montserrat"] text-base font-normal leading-6'>
