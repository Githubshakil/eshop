    ...
    <Container>
      <div className="flex justify-between items-center py-8">
        ...
        <div className="flex items-center">
          <div className="relative flex items-center mr-[110px]">
            <input
              className="w-[332px] border border-[rgba(48,48,48,0.35)] py-[18px] px-6 rounded-[10px] text-sm font-['Montserrat'] leading-6 text-[#303030] placeholder:text-[#303030] focus:outline-none "
              type="text"
              placeholder="Search Products ..."
            />
            <SearchIcon className=" absolute top-1/2 right-5 -translate-y-1/2" />
          </div>
